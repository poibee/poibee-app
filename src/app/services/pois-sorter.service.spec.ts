...
describe('PoisSorterService', () => {
  ...
  const pois = [
    ...
    new Poi('2', 'Marktkieker', ['community_centre'], null, new OwnPosition(null, 1, null), null, null, null, {}, 3, '{}'),
    new Poi('3', 'Christuskirche', ['church'], null, new OwnPosition(null, 2, null), null, null, null, {}, 1, '{}')
  ];
