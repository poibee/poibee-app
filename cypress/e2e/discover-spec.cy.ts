...
//      cy.get('@christuskircheItem').find('[data-cy=chipWebsite] a').should('have.attr', 'href', 'https://www.kirche-harpstedt.de/')
      cy.get('@christuskircheItem').find('[data-cy=chipWikidata]').should('have.text', 'Wikidata')
//      cy.get('@christuskircheItem').find('[data-cy=chipWikidata] a').should('have.attr', 'href', 'https://www.wikidata.org/wiki/Q1087325')
      cy.get('@christuskircheItem').find('[data-cy=chipWikipedia]').should('have.text', 'Wikipedia')
//      cy.get('@christuskircheItem').find('[data-cy=chipWikipedia] a').should('have.attr', 'href', 'https://de.wikipedia.org/wiki/Christuskirche (Harpstedt)')
    });
